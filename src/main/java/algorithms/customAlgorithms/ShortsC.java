...
public class ShortsC extends Algorithm {
    ...
    private void updateHistory(BigDecimal price) {
        ...
        var old30s = currentTimestamp - 30000L;
        while (historicalTimestamps.size() > 0 && historicalTimestamps.get(0) < old30s) {
    ...
    public String getDescription() {
        return "Constantly day trades based on 30s history.";
    }
}
